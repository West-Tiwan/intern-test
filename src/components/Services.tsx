        ...
        <div className="mt-20 bg-gray-50 rounded-xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div className="bg-white rounded-lg p-6 shadow-sm text-center">
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Individual Session</h4>
              <div className="text-3xl font-bold text-emerald-700 mb-2">$200</div>
              <p className="text-gray-600">Per session</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm text-center">
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Couples Session</h4>
              <div className="text-3xl font-bold text-emerald-700 mb-2">$240</div>
              <p className="text-gray-600">Per session</p>
            </div>
          </div>
