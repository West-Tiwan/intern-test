        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-2 flex flex-col justify-center items-center">
            <div className="flex flex-col justify-center items-center mb-6">
              ...
              <p className="text-emerald-200 text-sm">PsyD, Licensed Clinical Psychologist</p>
            </div>
          ...
          <div className="md:col-span-2 flex flex-col justify-start items-center">
            ...
            <div className="space-y-4">
              <div className="flex items-start group">
                <div className="w-8 h-8 bg-emerald-700 rounded-lg flex items-center justify-center mr-3 mt-0.5 group-hover:bg-emerald-600 transition-colors">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
                  </svg>
                </div>
                <div>
                  <p className="text-emerald-100 text-sm font-medium w-fit">Office</p>
                  <a
                    href="https://maps.google.com/?q=1287+Maplewood+Drive,+Los+Angeles,+CA+90026"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-emerald-200 hover:text-white transition-colors text-sm leading-relaxed"
                  >
              ...
              <div className="flex items-center group">
                <div className="w-8 h-8 bg-emerald-700 rounded-lg flex items-center justify-center mr-3 group-hover:bg-emerald-600 transition-colors">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" />
                  </svg>
                </div>
                <div>
                  <p className="text-emerald-100 text-sm font-medium w-fit">Phone</p>
                  <a
              ...
              <div className="flex items-center group">
                ...
                <div>
                  <p className="text-emerald-100 text-sm font-medium w-fit">Email</p>
                  <a
              ...
              <div className="mt-6 p-4 bg-emerald-700/50 rounded-lg">
                <h5 className="font-semibold mb-3 text-white text-sm">Office Hours</h5>
