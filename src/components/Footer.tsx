        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-2 flex flex-col justify-start items-center">
            ...
            <div className="space-y-3 sm:space-y-4 w-full max-w-sm">
              <div className="flex items-start group justify-center sm:justify-start">
                <div className="hidden sm:flex w-6 h-6 sm:w-8 sm:h-8 bg-emerald-700 rounded-lg items-center justify-center mr-2 sm:mr-3 mt-0.5 group-hover:bg-emerald-600 transition-colors flex-shrink-0">
              ...
              <div className="flex items-center group justify-center sm:justify-start">
                <div className="hidden sm:flex w-6 h-6 sm:w-8 sm:h-8 bg-emerald-700 rounded-lg items-center justify-center mr-2 sm:mr-3 group-hover:bg-emerald-600 transition-colors flex-shrink-0">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-emerald-700/50 rounded-lg">
                <h5 className="font-semibold mb-2 sm:mb-3 text-white text-xs sm:text-sm text-center sm:text-left">Office Hours</h5>
